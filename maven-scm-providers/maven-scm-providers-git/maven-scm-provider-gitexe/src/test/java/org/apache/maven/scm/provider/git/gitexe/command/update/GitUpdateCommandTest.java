    ...
    extends ScmTestCase
{
    public void testCommandLineNoBranch()
        throws Exception
    {
        testCommandLine( "scm:git:http://foo.com/git", null, "git pull --rebase http://foo.com/git master" );
    }

    public void testCommandLineWithBranch()
    throws Exception
    {
        testCommandLine( "scm:git:http://foo.com/git", new ScmBranch( "mybranch" ), "git pull --rebase http://foo.com/git mybranch" );
    }
